...
public class Client extends JFrame {
	...
	private String chatServer = "127.0.0.1"; // host server for this application
	private Socket client; // socket to communicate with server

	private int portNum;

	// initialize chatServer and set up GUI
	public Client(String portNumString) {
		super("Client");
	...
	private void connectToServer() throws IOException {
		displayMessage("Attempting connection on port " + portNum + "\n");
